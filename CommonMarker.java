...
public abstract class CommonMarker extends SimplePointMarker {
	...
	public CommonMarker(Location location, PImage icon) {
		super(location);
		this.icon = icon;
	}
	
	public CommonMarker(Location location, PImage icon, java.util.HashMap<java.lang.String,java.lang.Object> properties) {
